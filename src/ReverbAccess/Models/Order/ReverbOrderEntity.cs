...
namespace ReverbAccess.Models.Order
{
    public class ReverbOrderEntity
    {
        ...
        public DateTime CreatedAtDate
        {
            get
            {
                return DateTime.SpecifyKind(Convert.ToDateTime(this.CreatedAt), DateTimeKind.Utc);
            }
        }
        ...
        public DateTime PaidAtDate
        {
            get
            {
                return DateTime.SpecifyKind(Convert.ToDateTime(this.PaidAt), DateTimeKind.Utc);
            }
        }
        ...
        public ReverbOrderStatusEnum Status
        {
            get
            {
                ...
                {
                    case "unpaid": return ReverbOrderStatusEnum.Unpaid;
                    case "payment_pending": return ReverbOrderStatusEnum.PaymentPending;
                    case "paid": return ReverbOrderStatusEnum.Paid;
                    case "shipped": return ReverbOrderStatusEnum.Shipped;
                    case "picked_up": return ReverbOrderStatusEnum.PickedUp;
                    case "received": return ReverbOrderStatusEnum.Received;
                    case "presumed_received": return ReverbOrderStatusEnum.PresumedReceived;
                    case "cancelled": return ReverbOrderStatusEnum.Cancelled;
                    case "refunded": return ReverbOrderStatusEnum.Refunded;
                    default: return ReverbOrderStatusEnum.Default;
                }
            }
        }
        ...
        public DateTime UpdatedAtDate
        {
            get
            {
                return DateTime.SpecifyKind(Convert.ToDateTime(this.UpdatedAt), DateTimeKind.Utc);
            }
        }
