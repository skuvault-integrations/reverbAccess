...
namespace ReverbAccess
{
	public class ReverbProductsService : ReverbServiceBase, IReverbProductsService
	{
        ...
        public IEnumerable<ReverbProductEntity> GetProducts(String state, Int32? page = null, Int32? per_page = null)
        {
            ReverbProduct data = GetCommonProducts(state, page, per_page);
        ...
        public async Task<IEnumerable<ReverbProductEntity>> GetProductsAsync(String state, Int32? page = null, Int32? per_page = null)
        {
            ReverbProduct data = await GetCommonProductsAsync(state, page, per_page);
        ...
        private async Task<ReverbProductData> CollectProductsByIdAsync(string endpoint, string id)
        {
            ...
            await ActionPolicies.GetAsync.Do(async () =>
            {
                data = await this._webRequestServices.GetResponseAsync<ReverbProductData>(ReverbCommand.GetProductsById, new[] { id }, endpoint);
